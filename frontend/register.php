<?php
// frontend/register.php - Add session at the VERY TOP
session_start();
// No HTML or output before this line!
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="auth-container">
        <div class="auth-card">
            ...
            <form id="registerForm">
                ...
                <p class="auth-link">Already have an account? <a href="/frontend/login.php">Login here</a></p>
            </form>
